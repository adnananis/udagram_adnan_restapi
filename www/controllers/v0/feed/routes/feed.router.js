...
router.patch('/', auth_router_1.requireAuth, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    //     url: fileName
    //   });
    const saved_item = yield FeedItem_1.FeedItem.update(item, { where: { id: item.id } });
